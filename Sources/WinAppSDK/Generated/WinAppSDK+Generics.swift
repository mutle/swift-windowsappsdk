...
private var IID___x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurface: WindowsFoundation.IID {
    .init(Data1: 0xc89efa6d, Data2: 0x6f22, Data3: 0x5e04, Data4: ( 0x80,0x59,0xb5,0x62,0x8e,0x3f,0x01,0x80 ))// c89efa6d-6f22-5e04-8059-b5628e3f0180
}

internal extension WinRTDelegateBridge where CABI == __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurface {
    static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &WinAppSDK.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceVTable) { $0 }
        return .init(lpVtbl:vtblPtr)
    }
}

internal var __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceVTable: __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceVtbl = .init(
    QueryInterface: { __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper.addRef($0) },
    Release: { __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper.release($0) },
    Invoke: {
        guard let __unwrapped__instance = __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        let asyncInfo: WindowsFoundation.AnyIAsyncOperation<WinAppSDK.AnyICompositionSurface?>? = WinAppSDK.__x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper.unwrapFrom(abi: ComPtr($1))
        let asyncStatus: WindowsFoundation.AsyncStatus = $2
        __unwrapped__instance(asyncInfo, asyncStatus)
        return S_OK
    }
)
typealias __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper = InterfaceWrapperBase<WinAppSDK.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceBridge>
internal class AsyncOperationCompletedHandlerICompositionSurface: WindowsFoundation.IUnknown {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurface }

    internal func InvokeImpl(_ asyncInfo: WindowsFoundation.AnyIAsyncOperation<WinAppSDK.AnyICompositionSurface?>?, _ asyncStatus: WindowsFoundation.AsyncStatus) throws {
        let asyncInfoWrapper = WinAppSDK.__x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper(asyncInfo)
        let _asyncInfo = try! asyncInfoWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurface.self) { pThis in
...
internal class __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceBridge : WinRTDelegateBridge {
    internal typealias Handler = WindowsFoundation.AsyncOperationCompletedHandler<WinAppSDK.AnyICompositionSurface?>
    internal typealias CABI = __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurface
    internal typealias SwiftABI = WinAppSDK.AsyncOperationCompletedHandlerICompositionSurface
...
private var IID___x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurface: WindowsFoundation.IID {
    .init(Data1: 0x92ceaa5d, Data2: 0xb255, Data3: 0x57d9, Data4: ( 0xab,0x7c,0x0f,0x30,0x44,0x85,0xc1,0xbd ))// 92ceaa5d-b255-57d9-ab7c-0f304485c1bd
}

internal var __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceVTable: __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceVtbl = .init(
    QueryInterface: { __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper.addRef($0) },
    Release: { __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper.release($0) },
    GetIids: {
        let size = MemoryLayout<WindowsFoundation.IID>.size
        let iids = CoTaskMemAlloc(UInt64(size) * 4).assumingMemoryBound(to: WindowsFoundation.IID.self)
        iids[0] = IUnknown.IID
        iids[1] = IInspectable.IID
        iids[2] = WinAppSDK.__x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper.IID
    ...
    GetRuntimeClassName: {
        _ = $0
        let hstring = try! HString("Windows.Foundation.IAsyncOperation`1<Microsoft.UI.Composition.ICompositionSurface>").detach()
        $1!.pointee = hstring
        return S_OK
    },
    ...
    put_Completed: {
        guard let __unwrapped__instance = __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        guard let handler = WinAppSDK.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper.unwrapFrom(abi: ComPtr($1)) else { return E_INVALIDARG }
    ...
    get_Completed: {
        ...
        let resultWrapper = WinAppSDK.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper(result)
        resultWrapper?.copyTo($1)
        return S_OK
    },
...
internal class IAsyncOperationICompositionSurface: WindowsFoundation.IInspectable {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurface }

    internal func put_CompletedImpl(_ handler: AsyncOperationCompletedHandler<WinAppSDK.AnyICompositionSurface?>?) throws {
        let handlerWrapper = WinAppSDK.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper(handler)
        let _handler = try! handlerWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurface.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.put_Completed(pThis, _handler))
        }
    }

    internal func get_CompletedImpl() throws -> AsyncOperationCompletedHandler<WinAppSDK.AnyICompositionSurface?>? {
        let (result) = try ComPtrs.initialize { resultAbi in
            _ = try perform(as: __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurface.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.get_Completed(pThis, &resultAbi))
            }
        }
        return WinAppSDK.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceWrapper.unwrapFrom(abi: result)
    }

    internal func GetResultsImpl() throws -> WinAppSDK.AnyICompositionSurface? {
        let (result) = try ComPtrs.initialize { resultAbi in
            _ = try perform(as: __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurface.self) { pThis in
...
internal enum __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceBridge : AbiInterfaceBridge {
    internal typealias CABI = __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurface
    internal typealias SwiftABI = IAsyncOperationICompositionSurface
    internal typealias SwiftProjection = WindowsFoundation.AnyIAsyncOperation<WinAppSDK.AnyICompositionSurface?>
    internal static func from(abi: ComPtr<CABI>?) -> SwiftProjection? {
        guard let abi = abi else { return nil }
        return __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceImpl(abi)
    }

    internal static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &__x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceVTable) { $0 }
        return .init(lpVtbl: vtblPtr)
    }
}

fileprivate class __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceImpl : IAsyncOperation, AbiInterfaceImpl {
    typealias TResult = WinAppSDK.AnyICompositionSurface?
    typealias Bridge = __x_ABI_C__FIAsyncOperation_1___x_ABI_CMicrosoft__CUI__CComposition__CICompositionSurfaceBridge
    let _default: Bridge.SwiftABI
    init(_ fromAbi: ComPtr<Bridge.CABI>) {
        _default = Bridge.SwiftABI(fromAbi)
    }
    ...
    fileprivate func getResults() throws -> WinAppSDK.AnyICompositionSurface? {
...
private var IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectable: WindowsFoundation.IID {
    .init(Data1: 0xd81e5eac, Data2: 0xc5ba, Data3: 0x59aa, Data4: ( 0xae,0xd3,0xf8,0xaf,0xdd,0x07,0xa3,0x51 ))// d81e5eac-c5ba-59aa-aed3-f8afdd07a351
}

internal extension WinRTDelegateBridge where CABI == __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectable {
    static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &WinAppSDK.__x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectableVTable) { $0 }
        return .init(lpVtbl:vtblPtr)
    }
}

internal var __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectableVTable: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectableVtbl = .init(
    QueryInterface: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectableWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectableWrapper.addRef($0) },
    Release: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectableWrapper.release($0) },
    Invoke: {
        guard let __unwrapped__instance = __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectableWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        let sender: WinAppSDK.CompositionCapabilities? = .from(abi: ComPtr($1))
        let args: Any? = __ABI_.AnyWrapper.unwrapFrom(abi: ComPtr($2))
        __unwrapped__instance(sender, args)
        return S_OK
    }
)
typealias __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectableWrapper = InterfaceWrapperBase<WinAppSDK.__x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectableBridge>
internal class TypedEventHandlerCompositionCapabilities_Any: WindowsFoundation.IUnknown {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectable }

    internal func InvokeImpl(_ sender: WinAppSDK.CompositionCapabilities?, _ args: Any?) throws {
        let argsWrapper = __ABI_.AnyWrapper(args)
        let _args = try! argsWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectable.self) { pThis in
...
internal class __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectableBridge : WinRTDelegateBridge {
    internal typealias Handler = WindowsFoundation.TypedEventHandler<WinAppSDK.CompositionCapabilities?, Any?>
    internal typealias CABI = __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionCapabilities_IInspectable
    internal typealias SwiftABI = WinAppSDK.TypedEventHandlerCompositionCapabilities_Any
...
private var IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgs: WindowsFoundation.IID {
    .init(Data1: 0x2a8eb053, Data2: 0x059a, Data3: 0x54a0, Data4: ( 0x92,0x04,0x66,0x58,0x6a,0xb4,0xc8,0xd6 ))// 2a8eb053-059a-54a0-9204-66586ab4c8d6
}

internal extension WinRTDelegateBridge where CABI == __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgs {
    static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &WinAppSDK.__x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgsVTable) { $0 }
        return .init(lpVtbl:vtblPtr)
    }
}

internal var __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgsVTable: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgsVtbl = .init(
    QueryInterface: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgsWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgsWrapper.addRef($0) },
    Release: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgsWrapper.release($0) },
    Invoke: {
        guard let __unwrapped__instance = __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgsWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        let sender: WinAppSDK.CompositionGraphicsDevice? = .from(abi: ComPtr($1))
        let args: WinAppSDK.RenderingDeviceReplacedEventArgs? = .from(abi: ComPtr($2))
        __unwrapped__instance(sender, args)
        return S_OK
    }
)
typealias __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgsWrapper = InterfaceWrapperBase<WinAppSDK.__x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgsBridge>
internal class TypedEventHandlerCompositionGraphicsDevice_RenderingDeviceReplacedEventArgs: WindowsFoundation.IUnknown {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgs }

    internal func InvokeImpl(_ sender: WinAppSDK.CompositionGraphicsDevice?, _ args: WinAppSDK.RenderingDeviceReplacedEventArgs?) throws {
        _ = try perform(as: __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgs.self) { pThis in
...
internal class __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgsBridge : WinRTDelegateBridge {
    internal typealias Handler = WindowsFoundation.TypedEventHandler<WinAppSDK.CompositionGraphicsDevice?, WinAppSDK.RenderingDeviceReplacedEventArgs?>
    internal typealias CABI = __x_ABI_C__FITypedEventHandler_2___x_ABI_CMicrosoft__CUI__CComposition__CCompositionGraphicsDevice___x_ABI_CMicrosoft__CUI__CComposition__CRenderingDeviceReplacedEventArgs
