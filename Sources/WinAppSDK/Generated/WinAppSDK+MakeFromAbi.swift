...
fileprivate func makeICompositionSurfaceFacadeFrom(abi: WindowsFoundation.IInspectable) -> Any {
...
public class __MakeFromAbi: MakeFromAbi {
    public static func from(typeName: String, abi: WindowsFoundation.IInspectable) -> Any? {
        switch typeName {
            ...
            case "ICompositionSurfaceFacade": return makeICompositionSurfaceFacadeFrom(abi: abi)
